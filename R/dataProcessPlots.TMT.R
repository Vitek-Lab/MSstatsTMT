...
#' dataProcessPlots.TMT takes the quantitative data from converter functions (\code{\link{PDtoMSstatsTMTFormat}}, \code{\link{MQtoMSstatsTMTFormat}}) as input
...
#' @param data.psm name of the data with PSM-level, which can be the output of converter functions(\code{\link{PDtoMSstatsTMTFormat}}, \code{\link{MQtoMSstatsTMTFormat}}).
...
#' @param ylimDown lower limit for y-axis in the log scale. FALSE(Default) for Profile Plot and QC Plot is 0.
#' @param x.axis.size size of x-axis labeling for "Run" in Profile Plot and QC Plot.
#' @param y.axis.size size of y-axis labels. Default is 10.
#' @param text.size size of labels represented each condition at the top of graph in Profile Plot and QC plot. Default is 4.
#' @param text.angle angle of labels represented each condition at the top of graph in Profile Plot and QC plot. Default is 0.
#' @param legend.size size of legend above graph in Profile Plot. Default is 7.
...
#'                                          normalization=TRUE)
#'
#' dataProcessPlots.TMT(data.psm=required.input,
#'                      data.summarization=quant.byprotein,
#'                      type='ProfilePlot')
#'
#' dataProcessPlots.TMT(data.psm=required.input,
#'                      data.summarization=quant.byprotein,
